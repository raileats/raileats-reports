                    ...
                    <thead className="sticky top-0 z-10 text-slate-700">
                      ...
                      <tr className="bg-slate-300 font-extrabold text-slate-950">
                        {[
                          ...
                          vendorReportTotals['Previouse Balance'],
                          vendorReportTotals['Paid to Vendors By Relfood'],
                          vendorReportTotals['Payment Received from Vendor to Relfood'],
                        ...
                        .map((row: any, i: number) => (
                          <tr key={`${row['Aggregator Outlet ID']}-${i}`} className="portal-data-row">
                            {[
                              ...
                              row['Vendor Price'], row['Final Base Price'], row['Final Total Commission'], row['Final IRCTC Comm'],
                              row['Final RF Commission'], row['Final GST'], row['Final Discount'], row['Final Vendor Discount'],
                              row['Final RF Discount'], row['Delivery Charges'], row['Final Selling Price'], row['Final Order Total'],
                              row['Discounted Base Price'], row['PPD'], row['COD'], row['Meals'], row['Check'],
                              ...
                              row['Previouse Balance'], row['Paid to Vendors By Relfood'], row['Payment Received from Vendor to Relfood'], row['Net Payment']
                            ].map((value: any, j: number) => (
